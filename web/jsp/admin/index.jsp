...
<body>
	<div class="header container-fluid" style="background:#333333;"> 
		<a class="title" href="jsp/admin/main.jsp" target="rFrame">CAKE后台管理系统</a>
		<div class="btn-group adminName">
			...
			<ul class="dropdown-menu dropdown-menu-right">
			    <li><a href="LoginOutServlet" target="_top" onClick="return confirm('确定要退出系统了吗？')">
			    	退 出 登 录</a></li>
				<li><a href="jsp/cake/index.jsp" target="_top">
					返 回 商 城
				</a></li>
			</ul>
		</div>
